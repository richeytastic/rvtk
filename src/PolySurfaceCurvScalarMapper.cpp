...
// public
PolySurfaceCurvScalarMapper::PolySurfaceCurvScalarMapper( const ObjModelCurvatureMetrics* cm,
                                                          vtkActor* actor,
                                                          const IntIntMap* lookupMap,
                                                          const std::string& mname)
    : RVTK::SurfaceMapper( cm->model(), actor, lookupMap, mname, RVTK::PolygonMetricMapper::create(1)), _cmetrics(cm)
{
}   // end ctor
